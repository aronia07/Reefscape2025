...
public final class Constants {
 ...
 public static boolean enableTunableValues = true;
  ...
  public static final class WristConstants {
    ...
    public static double intakeMotorID;
    public static int absoluteEncoderPort;
    public static double[] wristPID;
    public static int maxVelocity;
    public static int maxAccel;
    public static double[] wristFF;
  ...
  public static final class ElevatorConstants {
      ...
      public static double homingCurrentThreshold;
    ...
    public static final class ArmConstants {
        ...
        public static final Rotation2d offset = Rotation2d.fromDegrees(0); // **WAS 88-90//How far away the arm is (at
                                                                           // rest) from 0 degrees
        ...
        public static final Rotation2d tolernace = Rotation2d.fromDegrees(1); // How much the arm's exact angle can be
                                                                              // off by
    public static final Rotation2d offset = Rotation2d.fromDegrees(-18);   //**WAS 88-90//How far away the arm is (at rest) from 0 degrees
    ...
    public static double[] armSGV = new double[] { 0.0, 0.0, 0.0 }; //Static, Gravity, and Velocity gains 
    public static double[] armPID = new double[] { 2, 0, 0f }; //Arm PID values
